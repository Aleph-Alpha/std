...
```go
import "github.com/Aleph-Alpha/std/v1/kafka"
```
...
<a name="ErrConnectionFailed"></a>Common Kafka error types that can be used by consumers of this package. These provide a standardized set of errors that abstract away the underlying Kafka\-specific error details.
...
## func [ValidateDataType](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L537>)
...
## type [AvroDeserializer](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L221-L224>)
...
### func \(\*AvroDeserializer\) [Deserialize](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L227>)
...
## type [AvroSerializer](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L197-L200>)
...
### func \(\*AvroSerializer\) [Serialize](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L203>)
...
## type [Deserializer](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L20-L23>)
...
## type [GobDeserializer](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L307>)
...
### func \(\*GobDeserializer\) [Deserialize](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L310>)
...
## type [GobSerializer](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L289>)
...
### func \(\*GobSerializer\) [Serialize](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L292>)
...
## type [JSONDeserializer](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L77>)
...
### func \(\*JSONDeserializer\) [Deserialize](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L80>)
...
## type [JSONSerializer](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L53>)
...
### func \(\*JSONSerializer\) [Serialize](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L56>)
...
## type [MultiFormatDeserializer](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L408-L414>)
...
### func [NewMultiFormatDeserializer](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L417>)
...
### func \(\*MultiFormatDeserializer\) [Deserialize](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L438>)
...
### func \(\*MultiFormatDeserializer\) [DeserializeWithFormat](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L453>)
...
### func \(\*MultiFormatDeserializer\) [RegisterDeserializer](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L430>)
...
## type [MultiFormatSerializer](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L352-L358>)
...
### func [NewMultiFormatSerializer](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L361>)
...
### func \(\*MultiFormatSerializer\) [RegisterSerializer](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L374>)
...
### func \(\*MultiFormatSerializer\) [Serialize](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L383>)
...
### func \(\*MultiFormatSerializer\) [SerializeWithFormat](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L398>)
...
## type [NoOpDeserializer](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L336>)
...
### func \(\*NoOpDeserializer\) [Deserialize](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L339>)
...
## type [NoOpSerializer](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L323>)
...
### func \(\*NoOpSerializer\) [Serialize](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L326>)
...
## type [ProtoMarshaler](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L35-L37>)
...
## type [ProtoMessage](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L27-L31>)
...
## type [ProtoUnmarshaler](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L40-L42>)
...
## type [ProtobufDeserializer](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L154-L159>)
...
### func \(\*ProtobufDeserializer\) [Deserialize](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L162>)
...
## type [ProtobufSerializer](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L110-L115>)
...
### func \(\*ProtobufSerializer\) [Serialize](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L118>)
...
<a name="Serializer"></a>
## type [Serializer](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L13-L16>)
...
## type [StringDeserializer](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L264>)
...
### func \(\*StringDeserializer\) [Deserialize](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L267>)
...
## type [StringSerializer](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L242-L245>)
...
### func \(\*StringSerializer\) [Serialize](<https://github.com/Aleph-Alpha/std/blob/main/v1/kafka/serializer.go#L248>)
