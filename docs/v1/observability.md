...
## type [NoOpObserver](<https://github.com/Aleph-Alpha/std/blob/main/v1/observability/noop.go#L6>)
...
### func \(\*NoOpObserver\) [ObserveOperation](<https://github.com/Aleph-Alpha/std/blob/main/v1/observability/noop.go#L9>)
...
<a name="Observer"></a>
## type [Observer](<https://github.com/Aleph-Alpha/std/blob/main/v1/observability/interface.go#L11-L15>)
...
### func [NewNoOpObserver](<https://github.com/Aleph-Alpha/std/blob/main/v1/observability/noop.go#L14>)
...
## type [OperationContext](<https://github.com/Aleph-Alpha/std/blob/main/v1/observability/interface.go#L20-L71>)
