...
```go
import "github.com/Aleph-Alpha/data-go-packages/pkg/tracer"
```
...
## func [RegisterTracerLifecycle](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/tracer/fx_module.go#L59>)
...
<a name="Config"></a>
## type [Config](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/tracer/configs.go#L6-L34>)
...
<a name="Span"></a>
## type [Span](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/tracer/utils.go#L31-L68>)
...
<a name="Tracer"></a>
## type [Tracer](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/tracer/setup.go#L31-L33>)
...
<a name="NewClient"></a>
### func [NewClient](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/tracer/setup.go#L67>)
...
### func \(\*Tracer\) [GetCarrier](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/tracer/utils.go#L288>)
...
### func \(\*Tracer\) [SetCarrierOnContext](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/tracer/utils.go#L341>)
...
### func \(\*Tracer\) [StartSpan](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/tracer/utils.go#L233>)
