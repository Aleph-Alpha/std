...
## func [RegisterRabbitLifecycle](<https://github.com/Aleph-Alpha/std/blob/main/pkg/rabbit/fx_module.go#L99>)
...
<a name="Channel"></a>
## type [Channel](<https://github.com/Aleph-Alpha/std/blob/main/pkg/rabbit/configs.go#L60-L92>)
...
<a name="Config"></a>
## type [Config](<https://github.com/Aleph-Alpha/std/blob/main/pkg/rabbit/configs.go#L6-L16>)
...
<a name="Connection"></a>
## type [Connection](<https://github.com/Aleph-Alpha/std/blob/main/pkg/rabbit/configs.go#L20-L56>)
...
## type [ConsumerMessage](<https://github.com/Aleph-Alpha/std/blob/main/pkg/rabbit/utils.go#L48-L51>)
...
### func \(\*ConsumerMessage\) [AckMsg](<https://github.com/Aleph-Alpha/std/blob/main/pkg/rabbit/utils.go#L287>)
...
### func \(\*ConsumerMessage\) [Body](<https://github.com/Aleph-Alpha/std/blob/main/pkg/rabbit/utils.go#L304>)
...
### func \(\*ConsumerMessage\) [Header](<https://github.com/Aleph-Alpha/std/blob/main/pkg/rabbit/utils.go#L342>)
...
### func \(\*ConsumerMessage\) [NackMsg](<https://github.com/Aleph-Alpha/std/blob/main/pkg/rabbit/utils.go#L299>)
...
<a name="DeadLetter"></a>
## type [DeadLetter](<https://github.com/Aleph-Alpha/std/blob/main/pkg/rabbit/configs.go#L97-L112>)
...
## type [ErrorCategory](<https://github.com/Aleph-Alpha/std/blob/main/pkg/rabbit/errors.go#L687>)
...
<a name="Message"></a>
## type [Message](<https://github.com/Aleph-Alpha/std/blob/main/pkg/rabbit/utils.go#L15-L44>)
...
<a name="Rabbit"></a>
## type [Rabbit](<https://github.com/Aleph-Alpha/std/blob/main/pkg/rabbit/setup.go#L18-L36>)
...
<a name="NewClient"></a>
### func [NewClient](<https://github.com/Aleph-Alpha/std/blob/main/pkg/rabbit/setup.go#L53>)
...
### func [NewClientWithDI](<https://github.com/Aleph-Alpha/std/blob/main/pkg/rabbit/fx_module.go#L68>)
...
### func \(\*Rabbit\) [Consume](<https://github.com/Aleph-Alpha/std/blob/main/pkg/rabbit/utils.go#L153>)
...
### func \(\*Rabbit\) [ConsumeDLQ](<https://github.com/Aleph-Alpha/std/blob/main/pkg/rabbit/utils.go#L182>)
...
### func \(\*Rabbit\) [GetErrorCategory](<https://github.com/Aleph-Alpha/std/blob/main/pkg/rabbit/errors.go#L708>)
...
### func \(\*Rabbit\) [GracefulShutdown](<https://github.com/Aleph-Alpha/std/blob/main/pkg/rabbit/fx_module.go#L135>)
...
### func \(\*Rabbit\) [IsAlarmError](<https://github.com/Aleph-Alpha/std/blob/main/pkg/rabbit/errors.go#L860>)
...
### func \(\*Rabbit\) [IsAuthenticationError](<https://github.com/Aleph-Alpha/std/blob/main/pkg/rabbit/errors.go#L831>)
...
### func \(\*Rabbit\) [IsChannelError](<https://github.com/Aleph-Alpha/std/blob/main/pkg/rabbit/errors.go#L819>)
...
### func \(\*Rabbit\) [IsConnectionError](<https://github.com/Aleph-Alpha/std/blob/main/pkg/rabbit/errors.go#L807>)
...
### func \(\*Rabbit\) [IsPermanentError](<https://github.com/Aleph-Alpha/std/blob/main/pkg/rabbit/errors.go#L780>)
...
### func \(\*Rabbit\) [IsResourceError](<https://github.com/Aleph-Alpha/std/blob/main/pkg/rabbit/errors.go#L844>)
...
### func \(\*Rabbit\) [IsRetryableError](<https://github.com/Aleph-Alpha/std/blob/main/pkg/rabbit/errors.go#L744>)
...
### func \(\*Rabbit\) [IsTemporaryError](<https://github.com/Aleph-Alpha/std/blob/main/pkg/rabbit/errors.go#L771>)
...
### func \(\*Rabbit\) [Publish](<https://github.com/Aleph-Alpha/std/blob/main/pkg/rabbit/utils.go#L241>)
...
### func \(\*Rabbit\) [RetryConnection](<https://github.com/Aleph-Alpha/std/blob/main/pkg/rabbit/setup.go#L229>)
...
### func \(\*Rabbit\) [TranslateError](<https://github.com/Aleph-Alpha/std/blob/main/pkg/rabbit/errors.go#L227>)
...
## type [RabbitLifecycleParams](<https://github.com/Aleph-Alpha/std/blob/main/pkg/rabbit/fx_module.go#L73-L79>)
...
## type [RabbitParams](<https://github.com/Aleph-Alpha/std/blob/main/pkg/rabbit/fx_module.go#L33-L37>)
