...
## func [RegisterLoggerLifecycle](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/logger/fx_module.go#L50>)
...
<a name="Config"></a>
## type [Config](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/logger/configs.go#L25-L60>)
...
<a name="Logger"></a>
## type [Logger](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/logger/setup.go#L14-L24>)
...
### func [NewLoggerClient](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/logger/setup.go#L53>)
...
### func \(\*Logger\) [Debug](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/logger/utils.go#L108>)
...
### func \(\*Logger\) [DebugWithContext](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/logger/utils.go#L213>)
...
### func \(\*Logger\) [Error](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/logger/utils.go#L149>)
...
### func \(\*Logger\) [ErrorWithContext](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/logger/utils.go#L258>)
...
### func \(\*Logger\) [Fatal](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/logger/utils.go#L172>)
...
### func \(\*Logger\) [FatalWithContext](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/logger/utils.go#L285>)
...
### func \(\*Logger\) [Info](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/logger/utils.go#L88>)
...
### func \(\*Logger\) [InfoWithContext](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/logger/utils.go#L191>)
...
### func \(\*Logger\) [Warn](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/logger/utils.go#L127>)
...
### func \(\*Logger\) [WarnWithContext](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/logger/utils.go#L234>)
