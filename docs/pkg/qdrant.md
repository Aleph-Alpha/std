...
## func [RegisterQdrantLifecycle](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/qdrant/fx_module.go#L54>)
...
<a name="Config"></a>
## type [Config](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/qdrant/configs.go#L24-L51>)
...
### func [DefaultConfig](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/qdrant/configs.go#L54>)
...
### func [FromEndpoint](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/qdrant/configs.go#L67>)
...
### func \(\*Config\) [WithApiKey](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/qdrant/configs.go#L74>)
...
### func \(\*Config\) [WithCompatibilityCheck](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/qdrant/configs.go#L99>)
...
### func \(\*Config\) [WithCompression](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/qdrant/configs.go#L89>)
...
### func \(\*Config\) [WithConnectTimeout](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/qdrant/configs.go#L84>)
...
### func \(\*Config\) [WithKeepAlive](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/qdrant/configs.go#L94>)
...
### func \(\*Config\) [WithTimeout](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/qdrant/configs.go#L79>)
...
<a name="Embedding"></a>
## type [Embedding](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/qdrant/utils.go#L16-L20>)
...
### func [NewEmbedding](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/qdrant/utils.go#L52>)
...
## type [EmbeddingInput](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/qdrant/utils.go#L9-L13>)
...
## type [QdrantClient](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/qdrant/setup.go#L35-L39>)
...
### func [NewQdrantClient](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/qdrant/setup.go#L56>)
...
### func \(\*QdrantClient\) [BatchInsert](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/qdrant/setup.go#L194>)
...
### func \(\*QdrantClient\) [Close](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/qdrant/setup.go#L123>)
...
### func \(\*QdrantClient\) [Delete](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/qdrant/setup.go#L314>)
...
### func \(\*QdrantClient\) [EnsureCollection](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/qdrant/setup.go#L137>)
...
### func \(\*QdrantClient\) [Insert](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/qdrant/setup.go#L178>)
...
### func \(\*QdrantClient\) [Search](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/qdrant/setup.go#L269>)
...
## type [QdrantParams](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/qdrant/fx_module.go#L39-L42>)
...
## type [SearchResult](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/qdrant/utils.go#L23-L29>)
...
### func \(SearchResult\) [GetCollectionName](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/qdrant/utils.go#L47>)
...
### func \(SearchResult\) [GetID](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/qdrant/utils.go#L32>)
...
### func \(SearchResult\) [GetMeta](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/qdrant/utils.go#L38>)
...
### func \(SearchResult\) [GetScore](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/qdrant/utils.go#L35>)
...
### func \(SearchResult\) [GetVector](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/qdrant/utils.go#L41>)
...
### func \(SearchResult\) [HasVector](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/qdrant/utils.go#L44>)
...
## type [SearchResultInterface](<https://github.com/Aleph-Alpha/data-go-packages/blob/main/pkg/qdrant/utils.go#L58-L65>)
